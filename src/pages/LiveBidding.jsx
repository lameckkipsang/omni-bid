  ...
  return (
    <div className="w-full bg-background min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-10 space-y-10">
        ...
        <div className="bg-card border border-border rounded-2xl p-6 shadow-sm grid grid-cols-1 lg:grid-cols-3 gap-8">
          
          {/* Item Preview */}
          <div className="lg:col-span-2 space-y-4">
            <div className="relative h-72 md:h-80 rounded-xl overflow-hidden border border-border">
